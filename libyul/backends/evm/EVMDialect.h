...
struct EVMDialect: public Dialect
{
	...
	BuiltinFunctionForEVM const* discardFunction() const { return builtin("pop"_yulstring); }
	BuiltinFunctionForEVM const* equalityFunction() const { return builtin("eq"_yulstring); }
